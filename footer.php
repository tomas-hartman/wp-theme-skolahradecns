<footer id="ft-flex">
    <div class="horni">
        ...
        <div class="ft-flex-horni-cont">
            <section class="sponsors"><a href="<?php echo get_site_url(); ?>/projekty-opvk/"><div class="image"><img src="<?php bloginfo('template_directory'); ?>/img/logolink.jpg" alt=""></div></a></section>
            <section class="sponsors"><a href="<?php echo get_site_url(); ?>/etwinning/"><div class="image" style="/*width: 100%;*/"><img src="<?php bloginfo('template_directory'); ?>/img/etwinning.svg" alt=""></div></a></section>
            <section class="sponsors"><a href="<?php echo get_site_url(); ?>/visegrad-fund/"><div class="image"><img src="<?php bloginfo('template_directory'); ?>/img/visegrad_fund_logo_blue_290px.png" alt=""></div></a></section>
            ...
            <section class="sponsors"><a href="<?php echo get_site_url(); ?>/msmt/"><div class="image"><img src="<?php bloginfo('template_directory'); ?>/img/msmtlogo.jpg" alt=""></div></a></section>
            <section class="sponsors"><a href="<?php echo get_site_url(); ?>/nadace-cez/"><div class="image"><img src="<?php bloginfo('template_directory'); ?>/img/logo_cez.png" alt=""></div></a></section>
        </div>
    </div>
    <div class="stredni">
